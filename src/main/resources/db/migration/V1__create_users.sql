...
('22222222-2222-2222-2222-222222222222', 'training', 'Video do Deschampo', 'DESCHAMPO malemá explica algo de TI, no fim do vídeo você entendeu nada e já quer lançar o BookFace 2.', -10, -10, 0.0, 10, 0.5, 0, 0, 0, 0, false, 0, 0, 'deschampo.json', 'deschampo.jpg', 0, CURRENT_TIMESTAMP,CURRENT_TIMESTAMP),
...
('44444444-4444-4444-4444-444444444444', 'market', 'Café Cafú', 'Tem mais galho, casca e pedra que cafe nessa bosta.', 5, -5, 0.0, 0, 0, 0, 0, 0,0, false, 0, 0, 'cafe_cafu.json', 'cafe_cafu.jpg', 0,CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
